...
export function useTestCredential() {
  return useMutation({
    mutationFn: async (mcp_qualified_name: string): Promise<TestCredentialResponse> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/credentials/${encodeURIComponent(mcp_qualified_name)}/test`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${session.access_token}`,
        },
...
export function useMarketplaceTemplates(params?: {
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<AgentTemplate[]> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/templates/marketplace?${searchParams}`, {
        headers: {
          'Authorization': `Bearer ${session.access_token}`,
        },
      });
...
export function useTemplateDetails(template_id: string) {
  return useQuery({
    ...
    queryFn: async (): Promise<AgentTemplate> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/templates/${template_id}`, {
        headers: {
          'Authorization': `Bearer ${session.access_token}`,
        },
      });
...
export function useCreateTemplate() {
  ...
  return useMutation({
    mutationFn: async (request: CreateTemplateRequest): Promise<{ template_id: string; message: string }> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/templates`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`,
...
export function useMyTemplates() {
  return useQuery({
    ...
    queryFn: async (): Promise<AgentTemplate[]> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/templates/my`, {
        headers: {
          'Authorization': `Bearer ${session.access_token}`,
        },
      });
...
export function usePublishTemplate() {
  ...
  return useMutation({
    mutationFn: async ({ template_id, tags }: { template_id: string; tags?: string[] }): Promise<{ message: string }> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/templates/${template_id}/publish`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`,
...
export function useUnpublishTemplate() {
  ...
  return useMutation({
    mutationFn: async (template_id: string): Promise<{ message: string }> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/templates/${template_id}/unpublish`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`,
...
export function useInstallTemplate() {
  ...
  return useMutation({
    mutationFn: async (request: InstallTemplateRequest): Promise<InstallationResponse> => {
      ...
      const response = await fetch(`${API_URL}/api/secure-mcp/templates/install`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${session.access_token}`,
