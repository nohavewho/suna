...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Agent AZ',
    description: 'Replay this Agent conversation on Agent AZ',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Agent AZ';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Agent AZ';
